...
- Review su diversi indici di centralità in base al ranking da loro prodotti e la similarità con il ranking reale della stagione.
...
- Sentiment Analysis sui tweet che menzionano un concorrente, stimando così per ogni concorrente uno score di *likeability*.
...
- Scraping:
    - [Raccolta informazioni sui concorrenti](ScrapWikiDrag.ipynb)
